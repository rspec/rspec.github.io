...
_Given_ a file named "filter_before_example_hooks_spec.rb" with:
...
_When_ I run `rspec filter_before_example_hooks_spec.rb`

_Then_ the examples should all pass.

## Filter `after(:example)` hooks using arbitrary metadata

_Given_ a file named "filter_after_example_hooks_spec.rb" with:
...
_When_ I run `rspec filter_after_example_hooks_spec.rb`

_Then_ the output should contain "3 examples, 2 failures".

## Filter `around(:example)` hooks using arbitrary metadata

_Given_ a file named "filter_around_example_hooks_spec.rb" with:
...
_When_ I run `rspec filter_around_example_hooks_spec.rb`

_Then_ the examples should all pass.

## Filter `before(:context)` hooks using arbitrary metadata

_Given_ a file named "filter_before_context_hooks_spec.rb" with:
...
_When_ I run `rspec filter_before_context_hooks_spec.rb`

_Then_ the examples should all pass.

## Filter `after(:context)` hooks using arbitrary metadata

_Given_ a file named "filter_after_context_hooks_spec.rb" with:
...
_When_ I run `rspec --format progress filter_after_context_hooks_spec.rb --order defined`
...
_Given_ a file named "less_verbose_metadata_filter.rb" with:
...
_When_ I run `rspec --format progress less_verbose_metadata_filter.rb`
...
_Given_ a file named "filter_example_hooks_with_symbol_spec.rb" with:
...
_When_ I run `rspec filter_example_hooks_with_symbol_spec.rb`

_Then_ the examples should all pass.

## Filtering hooks using a hash

_Given_ a file named "filter_example_hooks_with_hash_spec.rb" with:
...
_When_ I run `rspec filter_example_hooks_with_hash_spec.rb`

_Then_ the examples should all pass.

## Filtering hooks using a Proc

_Given_ a file named "filter_example_hooks_with_proc_spec.rb" with:
...
_When_ I run `rspec filter_example_hooks_with_proc_spec.rb`

_Then_ the examples should all pass.

## Filtering hooks using a regular expression

_Given_ a file named "filter_example_hooks_with_regexp_spec.rb" with:
...
_When_ I run `rspec filter_example_hooks_with_regexp_spec.rb`

_Then_ the examples should all pass.

## Filtering hooks using string comparison

_Given_ a file named "filter_example_hooks_with_strcmp_spec.rb" with:
...
_When_ I run `rspec filter_example_hooks_with_strcmp_spec.rb`
